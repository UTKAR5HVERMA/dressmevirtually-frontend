    ...
    <div className='questions section container '>
      ...
      <div className="secContainer grid">
        <div className="accordion grid"> 
          <Accordion 
            title="How does Dress Me Virtually work?" 
          ...
          />
          <Accordion 
            title="Do I need to download any software to use Dress Me Virtually?" 
          ...
          />
          <Accordion 
            title="Can I share my virtual outfits on social media?" 
        ...
        <div className=' form'>
          ...
          <div className="formContent grid">
            ...
            <button className='submitbtn btn'>Submit Inquiry</button>
          </div>
        </div>
      </div>
    </div> 
