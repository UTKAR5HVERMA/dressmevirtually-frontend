        ...
        <div className='secContainer container grid '>
          <div className="logoDiv">
            ...
            <div className='botom '>
              ...
              <div className='footerLinks info'>
              ...
              <div className='footerLinks helpful'>
                  <span className='linkTitle'>
                    Helpful Links
                  </span>
                  <li>
              ...
              <div className='footerLinks details'>
                  <span className='linkTitle'> Contact Details</span>
                  <span className='phone'>8770759205</span>
                  <span className='email'>utkarshverma759@gmail.com</span>
