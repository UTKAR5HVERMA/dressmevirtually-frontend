...
const Signup = () => {
  ...
  return (
    <div className='Fullpage bg-gradient-to-b from-gray-300 to-gray-700'>
    ...
    <div className='contentPage'>
      ...
      <form className="page">
        ...
        <p >Are you already member??<span className='pt' onClick={handleToggle} >Sign Up</span></p>
      </form>
    </div>
    </div>)}
    </div>
    ...
    <div className='contentPage'>
      ...
      <form className="page">
        ...
        <p>Are you already Sign IN??<span className='pt' onClick={handleToggle}>Sign In</span></p>
      </form>
    </div>
    </div>)}
      <div >
